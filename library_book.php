				...
				<div class="row" style="margin-left: 5px;width: 100%;">
					...
					<div class="collapse navbar-collapse text-center" id="collapsenavbar">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item">
								<a href="library_book.html" class="nav-link text-white">Student wise fee</a>
							</li>
			...
			<nav id="sidebar" class="sidebar-wrapper" style="margin-top:50px">
				...
				<main class="page-content ">
					...
					<div class="navbar navbar-expand-md  mt-5">
						<div class="container">
							<div class="col-6">
								<h2 style="float: left;margin: 2px;padding: 2px;font-weight: bold; ">Library</h2>
							</div>
							<div class="col-6">
								<input type="button" class="btn btn-info" data-toggle="modal" data-target="#viewModal" style="float: right" value="View Book">
							</div>
						</div>
					</div>
					<div class="topnav mt-4">
							...
							<div class="row mt-3">
								...
								<div class="col-md-12">
									<ul class="nav nav-tabs ml-10">
										<li class="nav-item">
											<a class="nav-link active show" href="#invoice_table" data-toggle="tab">Book List</a>
										</li>
										<li class="nav-item">
											<a class="nav-link  " href="#add_invoice" data-toggle="tab">Add Book</a>
										</li>
								...
								<div class="tab-pane active show" id="invoice_table">
									<div class="table-responsive mt-3">
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<?php 
													foreach ( $res as $manage_book ){
														echo("
															
												<tr>
													<td>1.</td>
													<td>{$manage_book["book_name"]}</td>
													<td>{$manage_book["author"]}</td>
													<td>{$manage_book["description"]}</td>
													<td>{$manage_book["price"]}</td>
													<td>{$manage_book["class_batch"]}</td>
													<td><button class=\"btn btn-danger\" style=\"border-radius: 16px;\">Not Available</button></td>
													<td>
								...
								<div class="tab-pane" id="add_invoice">
									<form>
										<div class="form-group">
											<label for="name" class="col-form-label">Book Id:</label>
										...
										<div class="form-group">
											<label for="class" class="col-form-label">Class/Batch:</label>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header bg-warning">
											<h5 style="font-weight: bold;">Edit Book</h5>
										...
										<div class="modal-body">
											<form>
												...
												<div class="form-group">
													<label for="description" class="col-form-label">Book Name:</label>
													<input type="text" class="form-control" id="description">
												</div>
												<div class="form-group">
													<label for="author" class="col-form-label">Author:</label>
							...
							<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header bg-warning">
											<h5 style="font-weight: bold;">Delete Book</h5>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
											</button>
										</div>
								...
								<div class="modal fade" id="viewModal">
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<!-- Modal Header -->
											<div class="modal-header bg-warning">
												<h4 class="modal-title" style="font-weight: bold;">View Books</h4>
												...
												<div class="table-responsive">
													<table class="table table-striped table-bordered table-hover">
														...
														<tbody>
															<tr>
																<td>Let Us C</td>
																<td>Yashwant Kanitkar</td>
																<td>Book on C language</td>
																<td>200</td>
																<td>Available</td>
															</tr>
															<tr>
