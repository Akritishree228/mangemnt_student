...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content" style="overflow-x:hidden">
      ...
      <div class="navbar navbar-expand-md  navbar-warning mt-5">
        <div class="container">
          <div class="col-6">
            <h2 style="float: left;margin: 2px;padding: 2px;font-weight:bold">Teacher Attendence</h2>
          </div>
          <div class="col-6">
      ...
      <div class="row">
                  ...
                  <div class="card-body">
                    <form >
                      ...
                      <div class="row">
                        ...
                        <div class="col-4 ">
                          <label for="" class="form-group has-float-label ml-1">
            ...
            <div class="modal-footer">
	            ...
	            <button type="button" class="btn btn-primary" dat-toggle="modal" data-target="#addModal">Add</button>
	        </div>
				    ...
				    <div class="modal-dialog modal-lg">
				      <div class="modal-content">
				        ...
				        <div class="modal-header bg-warning">
				          <h4 class="modal-title" style="font-weight: bold;">Teacher Attendance</h4>
                       ...
                       <img src="./images/pic/not_1.png" alt="profile_pic" style="width:100px;margin-left:10px">
					         	...
					         	<div class="col-8">
					         		<div class="row">
			                  			<div class="col-6" style="font-weight: bold;">Teacher Name:</div>
                            ...
                            <div class="row">
                              <div class="col-6" style="font-weight: bold;">Reason:</div>
                              <div class="col-6">Going out of station for 3 days</div>
                            </div>
			                  		<div class="row">
			            ...
			            <div class="modal-content">
			              ...
			              <div class="modal-body">
			                  ...
			                  <div class="form-group">
			                    <label for="name" class="col-form-label" style="font-weight: bold;">Teacher Name:</label>
                ...
                <div class="modal fade" id="addModal">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <!-- Modal Header -->
                      <div class="modal-header bg-warning">
                        <h4 class="modal-title" style="font-weight: bold;">Add Attendance</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                      </div>
